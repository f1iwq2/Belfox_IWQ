...
#define   infomarche  9     // D9  portB.1 
...
void loop() 
{
  ...
  if (!menu & !Etat_Fus) 
  {
    if (Fm_P) {consigne=rapide;proc_avance();}
    if (Fm_M) {consigne=rapide;proc_recul();} 
